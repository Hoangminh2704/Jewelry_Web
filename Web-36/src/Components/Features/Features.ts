...
export function initializeFeatures(containerId: string = 'features-container') {
  const container = document.getElementById(containerId);
  if (!container) {
    console.error(`Container with ID '${containerId}' not found for Features.`);
    return;
  }
    ...
    <div class="features">
      <div class="features__item">
        ...
        <div class="features__text">
          <p class="features__text-title">
            <span class="features__text-title-redNote">01. </span>Đồ trang
            sức độc đáo &amp; ý nghĩa
          </p>
      ...
      <div class="features__item wrap2">
        ${QualityIcon()}
        <div class="features__icon"></div>
        <div class="features__text">
          <p class="features__text-title">
            <span class="features__text-title-redNote">02. </span>Chất lượng
      ...
      <div class="features__item wrap3">
        ${RepeatIcon()}
        <div class="features__icon"></div>
        <div class="features__text">
          <p class="features__text-title">
            <span class="features__text-title-redNote">03. </span>Tuổi đời
...
const SearchIcon = () => `
  <svg
    ...
    fill="none"
  >
    <g clip-path="url(#clip0_4303_5704)">
      <path
