...
export function initializeHeader(containerId: string = 'header-container') {
    ...
    <div class="header">
      <div class="header--wrapper">
        <button
          title="hamburger"
          type="button"
          class="header-hamberger-mobile header-hamberger-mobile--htx"
        >
          <span class="header-hamberger-mobile-line"></span>
        </button>
        ...
        <nav class="header--sub-menu open">
        ...
        <div class="header--right">
          ...
          <div class="header--search-cart">
            ${CartIcon()}
            <p class="header--search-cart-counting">0</p>
          </div>
        </div>
      </div>
    </div>
  ...
  const hamburgerButtons = container.querySelectorAll(
    ".header-hamberger-mobile"
  ) as NodeListOf<HTMLElement>;

  const menu = container.querySelector(".open") as HTMLElement | null;
...
const CartIcon = () => `
  <svg
    ...
    fill="#161C24"
  >
    <g clip-path="url(#clip0_5628_1274)">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
