...
export function initializeShipping(containerId: string = 'shipping-container') {
  ...
  container.innerHTML = `
    <div class="Shipping">
      <div class="Shipping__title">
        <p class="Shipping__title-caption">
          <span class="shipping__title-top">
            Shopping online không ngại
          </span>
          <span class="shipping__title-bottom">
            khoảng cách
            <span class="Shipping__title-subtitle">FREE SHIP</span>
          </span>
        </p>
        <img class="Shipping__title-icon" src="${ellipse}" alt="" />
      </div>
      ...
      <div class="Shipping__button">
        <button type="button" class="Shipping__button-buying active">
          MUA NGAY
        </button>
        <button type="button" class="Shipping__button-more">
          XEM THÊM
        </button>
      </div>
      <div class="star-top">
